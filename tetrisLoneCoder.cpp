...
int main()
{
	...
	/*
	************Tetróminos********
	Un tetrominó es una forma geométrica compuesta de cuatro cuadrados iguales, conectados entre sí ortogonalmente (lado a lado).​ 
	Existen siete tipos distintos
	
	// Tetróminos libres o unilaterales
		I también poliominó recto, cuatro bloques en línea recta
		O también poliominó cuadrado, cuatro bloques en un cuadrado de 2x2
		T también poliominó en T, una fila de tres bloques con una añadido bajo el centro
	// Poliominós en L
		J Una fila de tres bloques con un agregado debajo del lado derecho
		L Una fila de tres bloques con un agregado debajo del lado izquierdo
	// Poliominós retorcidos
		S Dos fichas de dominó horizontales apiladas con el desplazamiento de la primera a la derecha
		Z Dos fichas de dominó horizontales apiladas con el desplazamiento de la primera a la izquierda
	 */
	/*
	//I			//T
	..X.		..X.
